...
if (currentTheme) {
  ...
  setTimeout(() => {
    document
      .querySelector(".theme-switch-wrapper")
...
// setTimeout(() => {
//   toggleSwitch.classList.remove("zero-opacity");
// }, 200);

/* PrismJS 1.26.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript+groovy */
var _self =
